...
module.exports.load = async(client) => {
  ...
  passport.use(new Strategy({
    ...
    callbackURL: `${client.config.dashboard.baseURL}:${client.config.dashboard.port}/login`,
    scope: scopes
  ...
  http.port = client.config.dashboard.port || 8080;
  http.client = client;
  ...
  app.listen(client.config.dashboard.port, () => client.logger.info(`Site web activé sur port ${client.config.dashboard.port}`)); 
